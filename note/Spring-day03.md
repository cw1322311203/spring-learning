...
![1591281580135](https://img-blog.csdnimg.cn/20201231161730973.png)

### 1.2)AOP开发思想

![1591281706237](https://img-blog.csdnimg.cn/20201231161807487.png)
...
![1591281844901](https://img-blog.csdnimg.cn/20201231161833494.png)
...
![1591281889446](https://img-blog.csdnimg.cn/20201231161856336.png)

![1591281914574](https://img-blog.csdnimg.cn/20201231161918372.png)

![1591281945260](https://img-blog.csdnimg.cn/20201231161943399.png)
...
![1591282302976](https://img-blog.csdnimg.cn/20201231162006775.png)

步骤三 把通知加入spring容器管理

![1591282320624](https://img-blog.csdnimg.cn/20201231162024489.png)
...
- 范例：
  ...
  ```xml
  execution（public User com.cw.service.UserService.findById（int））
  ```
...
- *：单个独立的任意符号，可以独立出现，也可以作为前缀或者后缀的匹配符出现
  ...
  ```xml
  execution（public * com.cw.*.UserService.find*（*））
  ```
...
// 规定了返回值类型为void，第一个包为com
execution(public void com..*.*(..)) 
// 规定了返回值类型为void，com包下的任意包下的service包
execution(public void com..service.*.*(..))
// 规定了返回值类型为void，com.cw.service包下的任意内容
execution(public void com.cw.service.*.*(..))
// 规定了返回值类型为void，com.cw.service包下的User开头的所有类或接口
execution(public void com.cw.service.User*.*(..))
// 规定了返回值类型为void，com.cw.service包下的Service结尾的所有类或接口
execution(public void com.cw.service.*Service.*(..))
// 规定了返回值类型为void，com.cw.service包下的UserService类或接口
execution(public void com.cw.service.UserService.*(..))
// 规定了返回值类型为User，com.cw.service包下的UserService类或接口中find开头的方法
execution(public User com.cw.service.UserService.find*(..))
// 规定了返回值类型为User，com.cw.service包下的UserService类或接口中Id结尾的方法
execution(public User com.cw.service.UserService.*Id(..))
// 规定了返回值类型为User，com.cw.service包下的UserService类或接口中findById方法
execution(public User com.cw.service.UserService.findById(..))
// 规定了返回值类型为User，com.cw.service包下的UserService类或接口中方法名为findById，参数为一个int参数
execution(public User com.cw.service.UserService.findById(int))
// 规定了返回值类型为User，com.cw.service包下的UserService类或接口中方法名为findById，参数为两个int参数
execution(public User com.cw.service.UserService.findById(int,int))
// 规定了返回值类型为User，com.cw.service包下的UserService类或接口中方法名为findById，参数为两个参数，第一个为int，第二个未知
execution(public User com.cw.service.UserService.findById(int,*))
// 规定了返回值类型为User，com.cw.service包下的UserService类或接口中方法名为findById，参数为两个参数，第一个未知，第二个为int
execution(public User com.cw.service.UserService.findById(*,int))
// 规定了返回值类型为User，com.cw.service包下的UserService类或接口中方法名为findById，参数为空参
execution(public User com.cw.service.UserService.findById())
// 规定了返回值类型为List，com.cw.service包下所有Service结尾的类和接口的子类或实现类中的findAll方法，不限定参数
execution(List com.cw.service.*Service+.findAll(..))
```
...
![1591284387913](https://img-blog.csdnimg.cn/20201231162128366.png)
...
![1591284429541](https://img-blog.csdnimg.cn/202012311621479.png)
...
![1591285050618](https://img-blog.csdnimg.cn/20201231162211772.png)
...
![1591285152119](https://img-blog.csdnimg.cn/20201231162231684.png)
...
![1591287238806](https://img-blog.csdnimg.cn/20201231162257971.png)
...
![1591287441096](https://img-blog.csdnimg.cn/20201231162317475.png)
...
![1591287839941](https://img-blog.csdnimg.cn/20201231162338625.png)